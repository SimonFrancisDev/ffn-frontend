...
const escrowReleasedToUser =
  earnings.escrowReleasedToUser ||
  0
        ...
        <div className="account-main-grid__right">
          ...
          <section className="account-surface wallet-snapshot">
            ...
            <div className="snapshot-list">
              ...
              <div className="snapshot-row">
                <span>Escrow Locked Lifetime</span>
                <strong>{getMoney(escrowLockedLifetime)}</strong>
              </div>
              <div className="snapshot-row">
                <span>Auto-upgrade Used</span>
                <strong>{getMoney(autoUpgradeUsed)}</strong>
              </div>
              <div className="snapshot-row">
              ...
              <div className="snapshot-row">
                <span>Escrow Released to User</span>
                <strong>{getMoney(escrowReleasedToUser)}</strong>
              </div>
            </div>
          </section>
