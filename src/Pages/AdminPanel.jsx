...
const TourManager = ({ isOwner, activeTab, setActiveTab }) => {
  ...
  return (
    <>
      ...
      {showWelcome && (
        <div className="tour-welcome-overlay" onClick={() => {}}>
          <div className="tour-welcome-card" onClick={e => e.stopPropagation()}>
            ...
            <h3>Welcome to Admin Cockpit!</h3>
            <p>This panel controls all governance operations for the protocol. Would you like a quick tour of the main features? (Takes about 60 seconds)</p>
            <div className="tour-welcome-buttons">
              <button className="btn-premium-secondary" onClick={handleWelcomeSkip}>Skip Forever</button>
              <button className="btn-premium-secondary" onClick={handleWelcomeLater}>Remind Later</button>
              <button className="btn-premium" onClick={handleWelcomeStart}>Start Tour</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showHelpButton && (
        <button className="tour-help-button" onClick={restartTour} title="Restart Tour">
          <HelpCircle size={24} />
        </button>
      )}
        ...
        <>
          ...
          >
            <div className="tour-tooltip-header">
              <span className="tour-step-badge">Step {currentStep + 1}/{tourSteps.length}</span>
            ...
            <div className="tour-tooltip-footer">
              <button className="tour-btn-skip" onClick={skipForever}>Skip Forever</button>
              <div>
                <button 
                ...
                <button className="tour-btn-next" onClick={nextStep}>
                  {currentStep + 1 === tourSteps.length ? 'Finish' : 'Next'}
                </button>
              </div>
            </div>
          </div>
...
export const AdminPanel = () => {
  ...
  }, [contracts, account, multisigTx?.txId, readTransaction, loadGuardianChecks, levelManagerAddress, fetchFounderBalances, skipAutoRefresh])
  ...
  return (
    <Container fluid="xl" className="admin-shell-premium">
      ...
      <nav className="command-dock">
        <button className={activeTab === 'dashboard' ? 'active' : ''} onClick={() => setActiveTab('dashboard')} title="Dashboard">
          <LayoutDashboard size={20} />
          <span>Dashboard</span>
        </button>
        <button className={activeTab === 'queue' ? 'active' : ''} onClick={() => setActiveTab('queue')} title="Tx Queue">
          <Activity size={20} />
          <span>Queue</span>
        </button>
        <button className={activeTab === 'security' ? 'active' : ''} onClick={() => setActiveTab('security')} title="Guardian">
          <ShieldCheck size={20} />
          <span>Security</span>
        </button>
        <button className={activeTab === 'founders' ? 'active' : ''} onClick={() => setActiveTab('founders')} title="Founder Ops">
          <Users size={20} />
          <span>Founders</span>
        </button>
        <button className={activeTab === 'community' ? 'active' : ''} onClick={() => setActiveTab('community')} title="Community">
          <Globe size={20} />
          <span>Community</span>
        </button>
        <button className={activeTab === 'multisig' ? 'active' : ''} onClick={() => setActiveTab('multisig')} title="Multisig Settings">
          <Settings size={20} />
          <span>Multisig</span>
        </button>
      ...
      <main className="admin-main-stage">
          ...
          <section className="fade-in">
            <Row className="g-3 mb-4">
              <Col xl={4}>
                <div className="admin-card-premium">
                  <div className="admin-header-premium" style={{padding: '10px'}}>
                    <div className="header-title" style={{textAlign: 'center'}}>Governance Model</div>
                  </div>
              ...
              <Col xl={8}>
                <div className="admin-card-premium">
                  <div className="admin-header-premium" style={{padding: '10px'}}>
                    <div className="header-title" style={{textAlign: 'center'}}>System Status</div>
                  </div>
                  <div className="admin-body-premium">
                    <Row className="g-2">
                      <Col md={6} xl={3}>
              ...
              <Col xl={12}>
                <div className="admin-card-premium" style={{padding: '10px'}}>
                  <div className="admin-header-premium">
                    <div className="header-title" style={{textAlign: 'center'}}>Quick Governance Actions</div>
                  </div>
                  <div className="admin-body-premium">
          ...
          <section className="fade-in">
            <Row className="g-3">
              <Col xl={7}>
                <div className="admin-card-premium" style={{padding: '10px'}}>
                  <div className="admin-header-premium">
                    <div className="header-title" style={{textAlign: 'center'}}>Recent Multisig Transactions</div>
                  </div>
                  <div className="admin-body-premium">
              ...
              <Col xl={5}>
                <div className="admin-card-premium">
                  <div className="admin-header-premium" style={{padding: '10px'}}>
                    <div className="header-title" style={{textAlign: 'center'}}>Selected Transaction Details</div>
                  </div>
                  <div className="admin-body-premium">
        ...
        {activeTab === 'security' && (
          <section className="fade-in">
            <div className="admin-card-premium" style={{padding: '10px'}}>
              <div className="admin-header-premium">
                <div className="header-title" style={{textAlign: 'center'}}>Guardian Approvals and Upgrade Flow</div>
              </div>
              <div className="admin-body-premium">
                <Row className="g-3">
                  <Col xl={4}>
        ...
        {activeTab === 'founders' && (
          <section className="fade-in">
            <div className="admin-card-premium" style={{padding: '10px'}}>
              <div className="admin-header-premium">
                <div className="header-title" style={{textAlign: 'center'}}>Founder Management</div>
                <button className="btn-premium btn-premium-sm" onClick={() => setShowChargeModal(true)}>Charge Routing</button>
              </div>
              <div className="admin-body-premium">
                <Accordion defaultActiveKey={['0']} alwaysOpen className="premium-accordion">
                  ...
                  <Accordion.Item eventKey="0">
                    <Accordion.Header>Founder Vault Distribution</Accordion.Header>
                    <Accordion.Body>
                  ...
                  <Accordion.Item eventKey="1">
                    <Accordion.Header>Update Proportions & Representatives</Accordion.Header>
                    <Accordion.Body>
                      <Row className="g-3">
                        <Col xl={6}>
      ...
      {/* VIEW: COMMUNITY CONTENT */}
        {activeTab === 'community' && (
          <section className="fade-in">
            <div className="admin-card-premium">
              <div className="admin-header-premium" style={{padding: '10px'}}>
                <div className="header-title" style={{textAlign: 'center'}}>Community Content Management</div>
                <button className="btn-premium btn-premium-sm" onClick={openCreateModal}>
                  <Plus size={12} /> Create New
                </button>
              </div>
                  ...
                  <table className="premium-table">
                    ...
                    <tbody>
                      {contentLoading ? (
                        ...
                        <tr>
                          <td colSpan={3} style={{ textAlign: 'center', color: 'rgba(255,255,255,0.4)' }}>
                            No items found.
                          </td>
                        </tr>
                      ) : (
        ...
        {activeTab === 'multisig' && (
          <section className="fade-in">
            <div className="admin-card-premium" style={{padding: '10px'}}>
              <div className="admin-header-premium">
                <div className="header-title" style={{textAlign: 'center'}}>Multisig Owner Management</div>
              </div>
              <div className="admin-body-premium">
                <Row className="g-3 mb-4">
                  <Col xl={3}>
        ...
        <div className="custom-modal-overlay" onClick={() => setShowContentModal(false)}>
          <div className="custom-modal-container" onClick={e => e.stopPropagation()}>
            <div className="custom-modal-header">
              ...
              <span>{editingItem ? 'Edit' : 'Create'} {activeContentTab.slice(0, -1)}</span>
              <button 
        ...
        <div className="custom-modal-overlay" onClick={() => {
          ...
          <div className="custom-modal-container" onClick={e => e.stopPropagation()}>
            <div className="custom-modal-header">
              ...
              <span>Configure NFT & Operations Wallets</span>
              <button 
                className="custom-modal-close" 
                onClick={() => {
                  setShowChargeModal(false)
            ...
            <div className="custom-modal-body">
              <div className="admin-subtitle" style={{ marginBottom: '20px' }}>
