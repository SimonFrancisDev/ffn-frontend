...
//   const fetchDashboardMetricSnapshot = useCallback(async () => {
...
//           ? contracts.usdt.balanceOf(CONTRACT_ADDRESSES.ESCROW)
//           : 0n,
//         contracts.levelManager ? contracts.levelManager.nftPool() : null,
//         contracts.levelManager ? contracts.levelManager.operationsWallet() : null,
//       ])

//       const [nftRaw, opsRaw] = await Promise.all([
//         nftPool ? contracts.usdt.balanceOf(nftPool) : 0n,
//         opsWallet ? contracts.usdt.balanceOf(opsWallet) : 0n,
//       ])

//       setLiveParticipantCount(Number(participantsRaw || 0n))
//       setEscrowBalance(Number(ethers.formatUnits(escrowRaw || 0n, 6)).toFixed(2))
//       setNftBalance(Number(ethers.formatUnits(nftRaw || 0n, 6)).toFixed(2))
//       setOpsBalance(Number(ethers.formatUnits(opsRaw || 0n, 6)).toFixed(2))
//     } catch (err) {
//       console.error('Error fetching dashboard metric snapshot:', err)
//     }
//   }, [contracts])
...
//                   <ShieldCheck size={18} />
//                 </span>
//                 <span className="community-metrics__label muted-text">Live Escrow Balance</span>
//                 <strong className="community-metrics__value gradient-text-gold">
//                   ${formatToken(escrowBalance)}
//                 </strong>
//               </div>
