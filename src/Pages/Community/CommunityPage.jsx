...
const CommunityPage = ({ onNavigate }) => {
  ...
  const buildGlobalMetricState = useCallback((publicData = {}, statsData = {}) => {
    return {
      ...
      // New source of truth from /api/community/summary.
          ...
          {shouldShowPrivateMoneyMetrics ? (
            <>
              <div className="community-metrics__card glass-panel" data-aos="fade-right" data-aos-delay="90">
                ...
                <span className="community-metrics__label muted-text">Total Generated Volume</span>
              ...
              <div className="community-metrics__card glass-panel" data-aos="fade-right" data-aos-delay="180">
                ...
                <span className="community-metrics__label muted-text">Current Escrow Locked</span>
                <strong className="community-metrics__value gradient-text-gold">
                  ${formatToken(communityGlobalStats.currentEscrowLocked)}
                </strong>
              </div>

              <div className="community-metrics__card glass-panel" data-aos="fade-right" data-aos-delay="225">
                <span className="community-metrics__icon">
                  <ShieldCheck size={18} />
                </span>
                <span className="community-metrics__label muted-text">Escrow Locked Lifetime</span>
                <strong className="community-metrics__value gradient-text-gold">
                  ${formatToken(communityGlobalStats.totalEscrowLockedLifetime)}
                </strong>
              </div>

              <div className="community-metrics__card glass-panel" data-aos="fade-right" data-aos-delay="250">
                <span className="community-metrics__icon">
                  <RefreshCw size={18} />
                </span>
                <span className="community-metrics__label muted-text">Auto-upgrade Used</span>
                <strong className="community-metrics__value gradient-text-blue">
