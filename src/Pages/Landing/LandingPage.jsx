...
const HERO_SLIDES = [
  ...
  },
  {
    ...
    image: {
      ...
      mobileDark: '/images/landing/hero-01-mobile-dark.png',
      mobileLight: '/images/landing/hero-01-mobile-light.png',
    },
  },
  {
    ...
    image: {
      ...
      mobileDark: '/images/landing/hero-02-mobile-dark.png',
      mobileLight: '/images/landing/hero-02-mobile-light.png',
    },
  },
  {
    ...
    image: {
      ...
      mobileDark: '/images/landing/hero-03-mobile-dark.png',
      mobileLight: '/images/landing/hero-03-mobile-light.png',
    },
  },
  {
    ...
    image: {
      ...
      mobileDark: '/images/landing/hero-04-mobile-dark.png',
      mobileLight: '/images/landing/hero-04-mobile-light.png',
    },
  },
  {
    ...
    image: {
      ...
      mobileDark: '/images/landing/hero-05-mobile-dark.png',
      mobileLight: '/images/landing/hero-05-mobile-light.png',
    },
  },
  {
    ...
    image: {
      ...
      mobileDark: '/images/landing/hero-06-mobile-dark.png',
      mobileLight: '/images/landing/hero-06-mobile-light.png',
    },
  },
  {
    ...
    <>
          ...
          <div className="landing-program-modal">
            ...
            <div className="landing-program-modal__dialog" role="dialog" aria-modal="true">
              ...
              <div className="landing-program-modal__image-wrap">
                <ThemeImage image={programModal.image} alt={programModal.title} className="landing-program-modal__image" />
              </div>
      ...
      <div className="landing-page">
          ...
          <div className="landing-hero__stage">
            <div className="landing-hero__slider" aria-label="Fin Freedom Network visual showcase">
              {HERO_SLIDES.map((slide, index) => (
                ...
                >
                  <ThemeImage image={slide.image} alt={slide.title} className="landing-hero__image" />
        ...
        <section id="programs" className="landing-section landing-program-showcase" data-aos="fade-up" data-aos-duration="1000">
          ...
          <div className="program-hybrid-grid">
            {PROGRAMS.map((program, index) => (
              // <article
              //   key={program.id}
              //   className={`program-hybrid-card program-hybrid-card--${program.type} program-animate-card ${
              //     program.isLive ? 'program-hybrid-card--live' : ''
              //   }`}
              //   data-aos="fade-up"
              ...
              <article
                  key={program.id}
                  className={`program-hybrid-card program-hybrid-card--${program.type} ${
                    program.isLive ? 'program-hybrid-card--live' : ''
                  }`}
                  data-aos={index % 3 === 0 ? 'fade-up-right' : index % 3 === 1 ? 'zoom-in-up' : 'fade-up-left'}
                  data-aos-delay={(index % 6) * 130}
                  data-aos-duration="1050"
                  data-aos-easing="ease-out-cubic"
                  data-aos-anchor-placement="top-bottom"
                  style={{ '--card-index': index }}
                >
                <div className="program-hybrid-card__media">
                  <ThemeImage
                    image={program.image}
                    alt={program.title}
                    className="program-hybrid-card__image"
                  />
                </div>

                <div className="program-hybrid-card__content">
                  <div className="program-hybrid-card__badge-row">
                  ...
                  {program.headline && <p className="program-hybrid-card__headline">{program.headline}</p>}

                  {program.description && (
                    <p className="program-hybrid-card__description">{program.description}</p>
                  )}
