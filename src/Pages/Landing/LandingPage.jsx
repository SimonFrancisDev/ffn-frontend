...
const PROGRAMS = [
  { id: 'f-freedom-program', title: 'F-Freedom Program', description: 'The foundational participation engine of the ecosystem, built around structured progression and transparent execution.', status: 'Phase 1 Focus', badge: 'Current Program', image: '/images/program-f-freedom.jpg', isLive: true, route: 'activation' },
...
const HERO_MESSAGE = 'Fin Freedom Network — A transparent, participation-driven ecosystem designed to reward contribution, progression, and long-term commitment. Built on smart contracts, governed by clear rules.'
      ...
      <div className="landing-page">
                ...
                <div className="landing-hero__panel glass-panel">
                  <div className="landing-hero__profile-switcher">
                    <div className="landing-hero__profile-switcher-head">
                      <div>
                        <span className="landing-hero__profile-switcher-label muted-text">Profile Address Viewer</span>
                        <p className="landing-hero__profile-switcher-note soft-text">
                          While you view your own address profile you can view another valid wallet profile.
                        </p>
                      </div>
                      ...
                      {!isOwnSpace && (
                        <button
                          type="button"
                          className="landing-hero__profile-return"
                    ...
                    <div className="landing-hero__profile-switcher-row">
                      <div className="landing-hero__profile-input-wrap">
                        <Search size={16} />
                        <input
                          type="text"
                          value={profileInput}
                          ...
                          className="landing-hero__profile-input"
                        />
                      </div>

                      <button type="button" className="landing-hero__profile-submit" onClick={handleViewProfile}>
                    ...
                    <div className="landing-hero__profile-meta">
                      <span className="landing-hero__profile-chip">
                        {isOwnSpace ? <Home size={14} /> : <Eye size={14} />}
                        <span>{isOwnSpace ? 'My Profile' : 'Visitor View'}</span>
                      </span>

                      <span className="landing-hero__profile-chip">
                        {canView ? <Eye size={14} /> : <Lock size={14} />}
                        <span>{canView ? 'Public Profile' : 'Private Profile'}</span>
                      </span>
                  ...
                  <div className="landing-hero__actions">
                    <button type="button" className="landing-hero__primary-btn" onClick={primaryCtaAction}>
                      {primaryCtaLabel}
                    </button>
                    <button
                      type="button"
              ...
              <div className="landing-hero__side">
                ...
                <div className="landing-hero__trust-row landing-hero__trust-row--compact">
                  <div className="landing-hero__trust-item glass-panel">
                    <span className="landing-hero__trust-label muted-text">Network Status</span>
                    <span className="landing-hero__trust-value">{systemStatusLabel}</span>
                  </div>
                  <div className="landing-hero__trust-item glass-panel">
                    <span className="landing-hero__trust-label muted-text">Your Status</span>
        ...
        <section className="landing-stats app-container">
          ...
          <div className="landing-stats__grid">
            <div className="landing-stats__card glass-panel">
              ...
              <span className="landing-stats__note soft-text">Total registered participants.</span>
            </div>
            ...
            <div className="landing-stats__card landing-stats__card--chart glass-panel">
              <div className="landing-stats__card-top">
                ...
                <div className="landing-stats__card-copy">
                  <span className="landing-stats__label muted-text">Membership rate</span>
                  <strong className="landing-stats__value">{publicStats.lastSyncLabel}</strong>
                </div>
              </div>
              <MiniGrowthChart series={growthSeries} />
              <span className="landing-stats__note soft-text">Recent registration movement.</span>
            </div>
            ...
            <div className="landing-stats__card glass-panel">
              ...
              <span className="landing-stats__label muted-text">USDT Flow</span>
              <strong className="landing-stats__value">{formatUsdt(publicStats.totalAmountMade)} USDT</strong>
              <span className="landing-stats__note soft-text">Combined visible value surfaced.</span>
            </div>
          </div>
        </section>
        ...
        <section className="landing-coins app-container">
          <div className="landing-section-heading">
            ...
            <p className="landing-section-heading__text soft-text">
              Earn tokens through qualifying events, with reserved space for future ecosystem assets.
            </p>
          </div>

          <div className="landing-coins__grid landing-coins__grid--triple">
            <TokenFlipCard
              image={TOKEN_IMAGES.fgt}
              alt="FGT Token"
              tag="FGT · First Activation"
              title="FGT Token"
              description="Issued on verified first-time level activation, forming part of the ecosystem's utility design."
              bullets={['First-time activation reward', 'On-chain verifiable activity', 'Designed for ecosystem utility']}
              variant="fgt"
              delay={0}
            />

            <TokenFlipCard
              image={TOKEN_IMAGES.fgtr}
              alt="FGTr Token"
              tag="FGTr · Reactivation"
              title="FGTr Token"
              description="Issued during qualifying reactivation events, mirroring the utility direction of FGT."
              bullets={['Reactivation event reward', 'Aligned with FGT utility', 'Excluded from NFT rules']}
              variant="fgtr"
              delay={2000}
            />
            ...
            <div className="landing-coins__card glass-panel landing-coins__card--coming">
              <div className="landing-coins__visual landing-coins__visual--placeholder">
                <div className="landing-coins__visual-glow" />
                <img src={TOKEN_IMAGES.ffc} alt="Upcoming token" className="landing-coins__token-image" loading="lazy" />
              ...
              <div className="landing-coins__content">
                ...
                <p className="landing-coins__text soft-text">Reserved panel for the next generation of ecosystem assets.</p>
                <div className="landing-coins__bullets">
                  <span className="landing-coins__bullet">Reserved token slot</span>
                  <span className="landing-coins__bullet">Prepared for expansion</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="landing-programs app-container">
          <div className="landing-section-heading">
            ...
            <p className="landing-section-heading__text soft-text">
              Each layer plays a distinct role in onboarding, rewards, and long-term participation.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="landing-programs__overlay">
                    <div className="landing-programs__topbar">
                      ...
                      <span className={`landing-programs__badge ${program.isLive ? 'landing-programs__badge--live' : 'landing-programs__badge--soon'}`}>
                        {program.badge}
                      </span>
                    </div>
                    ...
                    >
                      ...
                      <span className="landing-footer__service-copy">
                        ...
                        {!service.isLive ? (
                          ...
                          <span className="landing-footer__service-badge landing-footer__service-badge--live">Current</span>
                        )}
                      </span>
                    </button>
                  ))}
...
//                   Fin Freedom Network is a wallet-first blockchain application. Please read this notice carefully.
//                 </p>
//               </div>
...
//                     <p className="landing-disclaimer__section-text soft-text">
//                       Transactions confirmed on-chain are irreversible.
//                     </p>
//                   </div>
//                 </div>
...
//                   </div>
//                   <div>
//                     <h3 className="landing-disclaimer__section-title">Public profiles</h3>
//                     <p className="landing-disclaimer__section-text soft-text">
//                       Viewing another profile does not grant transaction authority.
//                     </p>
//                   </div>
//                 </div>
...
//               <div className="landing-disclaimer__consent landing-disclaimer__consent--static">
//                 <span>By continuing, you confirm that you understand the notice above.</span>
//               </div>

//               <div className="landing-disclaimer__actions">
//                 <button type="button" className="landing-disclaimer__primary" onClick={handleAcknowledgeDisclaimer}>
//                   I Understand
//                 </button>
//               </div>
//             </div>
...
//                 <div className="landing-hero__text-block">
//                   <h1 className="landing-hero__title">
//                     Fin Freedom Network Program, Welcome to the Largest community in the Ecosystem
//                   </h1>
//                   <p className="landing-hero__description soft-text">
//                     Move through activation with confidence, track public profiles, and progress through the orbit
//                     program with a cleaner wallet-first experience.
//                   </p>
//                 </div>
...
//                       <span className="third" />
//                     </div>
//                     <span className="landing-hero__terminal-label">Guide</span>
//                   </div>
//                   <p className="landing-hero__terminal-text">
//                     {typedHeroMessage}
//                     <span className="landing-hero__typing-caret" />
...
//                 <div className="landing-hero__trust-row landing-hero__trust-row--compact">
//                   <div className="landing-hero__trust-item glass-panel">
//                     <span className="landing-hero__trust-label muted-text">Notice</span>
//                     <span className="landing-hero__trust-value">{systemStatusLabel}</span>
//                   </div>
//                   <div className="landing-hero__trust-item glass-panel">
//                     <span className="landing-hero__trust-label muted-text">Certificate</span>
//                     <span className="landing-hero__trust-value">{registrationLabel}</span>
//                   </div>
//                   <div className="landing-hero__trust-item glass-panel">
//                     <span className="landing-hero__trust-label muted-text">Next Action</span>
...
//                   <span>Support</span>
//                 </button>
//                 <button type="button" className="landing-footer__link landing-footer__link--icon" onClick={() => onNavigate?.('home')}>
//                   <BadgeInfo size={16} />
//                   <span>Current Program</span>
//                 </button>
//               </div>
...
//               <div className="landing-footer__column">
//                 <h3 className="landing-footer__heading">Legal</h3>
//                 <button type="button" className="landing-footer__link landing-footer__link--icon" onClick={handleOpenRiskNotice}>
//                   <TriangleAlert size={16} />
//                   <span>Risk Disclaimer</span>
//                 </button>
//                 <button type="button" className="landing-footer__link landing-footer__link--icon" onClick={handleOpenRiskNotice}>
