...
const HERO_TYPING_MESSAGES = [
  'Welcome to Fin Freedom Program, the largest community...',
  'Hi, i am just a simple narrator designed to explain to you what is happening in the background for transparency',
  'Initializing live read layer...',
  'Verifying wallet-first access protocol...',
  'Orbit matrices detected: P4, P12, P39.',
  'Structured progression available from FFN-Mercury [Level 1] to FFN-Star [Level 10]...',
  'Public space visibility enabled for transparent review only.',
  'State-changing actions remain user-signed and wallet controlled.',
  'Activation, reactivation, and utility signals are ready for inspection.',
]
    ...
    <>
      <ModalPortal>
        ...
        <AnimatePresence>
          {programModal ? (
            <motion.div
              className="landing-program-modal"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            >
              <motion.div
                className="landing-program-modal__backdrop"
                onClick={() => setProgramModal(null)}
              />
              <motion.div
                className="landing-program-modal__dialog glass-panel"
              ...
              >
                ...
                <div className="landing-program-modal__content">
                  ...
                  <p className="landing-program-modal__text soft-text">
      ...
      <section className="landing-page">
        <section className="landing-hero">
          ...
          <div className="landing-hero__container app-container">
            <motion.div
              className="landing-hero__layout"
              ...
              <div className="landing-hero__side">
                <div className="landing-hero__terminal">
                  ...
                  <p className="landing-hero__terminal-text">
                    {typingDisplay}
                    <span className="landing-hero__description-caret-hero" />
                  </p>
                </div>
...
// const API_BASE_URL = 'https://ffn-backend-qx15.onrender.com'
...
//   'Verifying wallet-first access protocol...',
//   'Orbit matrices detected: P4, P12, P39.',
//   'Structured progression available from FFN-Mecury[level 1] to FFN-Star[level 10]...',
//   'Public space visibility enabled for transparent review only.',
//   'State-changing actions remain user-signed and wallet controlled.',
//   'Activation, reactivation, and utility signals are ready for inspection.',
// ]
...
//               exit={{ opacity: 0 }}
//             >
//               <motion.div className="landing-program-modal__backdrop" />
//               <motion.div
//                 className="landing-program-modal__dialog glass-panel"
//                 initial={{ opacity: 0, y: 20, scale: 0.98 }}
//                 animate={{ opacity: 1, y: 0, scale: 1 }}
