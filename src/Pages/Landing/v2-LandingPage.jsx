...
const HERO_TYPING_MESSAGES = [
  '[FFNNarrator] Initializing live read layer...',
  '[FFNNarrator] Verifying wallet-first access protocol...',
  '[FFNNarrator] Orbit matrices detected: P4, P12, P39.',
  '[FFNNarrator] Structured progression available from FFN-Mercury to FFN-Star.',
  '[FFNNarrator] Public space visibility enabled for transparent review only.',
  '[FFNNarrator] State-changing actions remain user-signed and wallet controlled.',
  '[FFNNarrator] Activation, reactivation, and utility signals are ready for inspection.',
]
          ...
          <div className="landing-hero__container app-container">
            ...
            >
              ...
              <div className="landing-hero__side">
                <div className="landing-hero__terminal glass-panel">
            ...
            <div className="landing-coins__card glass-panel landing-coins__card--coming">
              ...
              <div className="landing-coins__content">
                ...
                <p className="landing-coins__text soft-text">
                  ...
                  next ecosystem assets are introduced.
                </p>
