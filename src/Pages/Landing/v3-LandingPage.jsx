...
const TokenFlipCard = ({ image, alt, tag, title, description, bullets, variant = 'fgt', delay = 0 }) => {
  ...
  return (
    <div className={`landing-coins__card glass-panel ${isFlipped ? 'token-flip' : ''}`}>
            ...
            <div className="landing-hero__layout">
              <div className="landing-hero__content">
                ...
                <div className="landing-hero__text-block">
                  ...
                  <p className="landing-hero__description soft-text">.......... An opportunity to subscribe in the orbit program, move through activation with confidence, earn your way through the level up,  view public profiles, and many more..........</p>
                </div>
