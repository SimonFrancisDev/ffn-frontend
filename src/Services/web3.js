...
import MULTISIG_ABI from '../abis/SimpleMultiSig.json'
import GUARDIAN_ABI from '../abis/Guardian.json'
...
export class Web3Service {
  ...
  initReadContracts() {
    if (this.readContracts && Object.keys(this.readContracts).length > 0) {
    ...
    this.readContracts = {
      ...
      // Governance
      simpleMultiSig: new ethers.Contract(
        CONTRACT_ADDRESSES.MULTISIG,
        MULTISIG_ABI,
        provider
      ),
      guardian: new ethers.Contract(
